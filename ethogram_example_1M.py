...
PURSUIT_MIN_DURATION = 5.0  # Minimum duration for pursuit (seconds)
...
for female_id in female_ids:
    ...
    for i in range(len(within_distance)):
        # accumulate duration_frames by updating start_idx, once within_distance is 0 again, check duration and define if copulation, and reset copulation to false. 
